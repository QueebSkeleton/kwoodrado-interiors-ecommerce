      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">List of Denied Orders</h3>
          ...
          <?php
            ...
            $orders_result = mysqli_query($conn, "SELECT placed_order.id, customer.first_name, customer.".
              ...
              "LEFT JOIN customer ON customer.email_address = placed_order.customer_email_address WHERE placed_order.status = 'DENIED'");
          ?>
          <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                ...
                <tr>
                  <td colspan="5" class="text-center">There are no denied orders as of the moment.</td>
                </tr>
                <?php endif; ?>
              </tbody>
            </table>
