...
<div class="modal-body">
 <div class="callout callout-info">
    <h5><i class="fas fa-info-circle"></i> Denying orders</h5>
    <p>After denying an order, the customer will be notified. The order will also be rendered invalid and can be seen in the denied orders panel.</p>
  </div>
...
<div class="modal-footer justify-content-between">
  ...
  <button data-href="/admin/orders/actions/deny-order.php?id=<?= $placed_order -> id ?>" class="btn btn-danger" id="btn-final-deny">Deny</a>
</div>
