...
<head>
  ...
  <title>Kwoodrado Interiors | Add Customer</title>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="phone_number" class="form-control" id="phone_number" placeholder="Enter 11-digit phone number">
              </div>
              <div class="form-group">
                <label for="email_address">Email Address</label>
                <input type="email" name="email_address" class="form-control" id="email_address" placeholder="Enter email address">
              </div>
              <div class="form-group">
