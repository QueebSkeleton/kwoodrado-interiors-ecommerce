<?php
  ...
  $connect->query("INSERT INTO placed_order (customer_email_address, shipping_address, billing_address, additional_notes, placed_in, status) VALUES ('$user_logged_in_email', '$shipping_address', '$billing_address', '$additional_notes', NOW(), 'NEW') ");
